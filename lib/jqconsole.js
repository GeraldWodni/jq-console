          ...
          return function(indent) {
            ...
            if (indent !== false) {
              ...
              if (_this.history_active) {
                if ((!_this.history.length || _this.history[_this.history.length - 1] !== text) && !(_this.IgnoreInHistory && _this.IgnoreInHistory.length > 0 && _this.IgnoreInHistory.indexOf(text) >= 0)) {
                  if( !_this.IgnoreInHistory.filter(function(i){ return i instanceof RegExp }).some(function(regExp){regExp.lastIndex = 0; return regExp.test( text )} ) )
